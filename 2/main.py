...
graph = {
    'Червоний університет': {'Михайлівський собор': {'is_direct': False, 'weight': 1}, 'Київська політехніка': {'is_direct': False, 'weight': 2}},
    'Андріївська церква': {'Михайлівський собор': {'is_direct': True, 'weight': 3}},
    'Михайлівський собор': {'Софія київська': {'is_direct': True, 'weight': 2}, 'Фунікулер(нижня станція)': {'is_direct': False, 'weight': 3}},
    'Золоті ворота': {'Фонтан на Хрещатику': {'is_direct': True, 'weight': 1}},
    'Лядські ворота': {'Михайлівський собор': {'is_direct': True, 'weight': 3}},
    'Фунікулер(нижня станція)': {'Музей однієї вулиці': {'is_direct': True, 'weight': 3}, 'Фунікулер(верхня станція)': {'is_direct': False, 'weight': 3}},
    'Фунікулер(верхня станція)': {'Софія київська': {'is_direct': True, 'weight': 4}},
    'Київська політехніка': {},
    'Фонтан на Хрещатику': {'Національна філармонія': {'is_direct': False, 'weight': 1}},
    'Софія київська': {'Лядські ворота': {'is_direct': True, 'weight': 3}},
    'Національна філармонія': {'Київська політехніка': {'is_direct': False, 'weight': 3}},
    'Музей однієї вулиці': {}
}
